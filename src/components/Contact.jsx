      ...
      <div className="max-w-6xl w-full grid md:grid-cols-2 gap-8">
        ...
        <div className="bg-zinc-950 border border-zinc-800 rounded-2xl shadow-xl p-8">
          ...
          <form className="space-y-5">
            ...
            <button
              type="submit"
              className="w-full py-3 bg-emerald-500 hover:bg-zinc-900 border border-emerald-500 text-white rounded-md font-semibold transition duration-300"
            >
              🚀 Send Message
            </button>
          </form>
          ...
          <div className="mt-10 border-t border-zinc-700 pt-4 text-white">
            ...
            <div className="flex gap-4">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-emerald-400 text-3xl hover:opacity-80 transition"
              >
                <FaGithub />
              </a>
              <a
