...
const skillsData = [
  { name: "HTML5", level: 100, category: "Frontend", icon: <FaHtml5 />, color: "text-orange-500" },
  { name: "CSS3", level: 95, category: "Frontend", icon: <FaCss3Alt />, color: "text-blue-500" },
  { name: "JavaScript", level: 95, category: "Frontend", icon: <FaJsSquare />, color: "text-yellow-400" },
  { name: "React", level: 100, category: "Frontend", icon: <FaReact />, color: "text-cyan-400" },
  { name: "Redux", level: 90, category: "Frontend", icon: <SiRedux />, color: "text-purple-500" },
  { name: "Tailwind", level: 95, category: "Frontend", icon: <SiTailwindcss />, color: "text-sky-400" },
  { name: "Bootstrap", level: 100, category: "Frontend", icon: <FaBootstrap />, color: "text-purple-700" },
  { name: "Node.js", level: 90, category: "Backend", icon: <FaNodeJs />, color: "text-green-500" },
  { name: "Express", level: 90, category: "Backend", icon: <SiExpress />, color: "text-gray-300" },
  { name: "MongoDB", level: 95, category: "Backend", icon: <SiMongodb />, color: "text-green-400" },
  ...
  { name: "Figma", level: 75, category: "Tools", icon: <FaFigma />, color: "text-pink-500" },
  { name: "Illustrator", level: 75, category: "Tools", icon: <SiAdobeillustrator />, color: "text-orange-600" },
